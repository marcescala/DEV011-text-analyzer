Esta página está diseñada para que la usuaria pueda obtener información útil y estadísticas de un texto que ella misma ingrese, y así pueda utilizar esa información para su propio beneficio.
